...
<a id="btnEmpty" href="index.php?content=productenpage&action=empty">Alles verwijderen</a>
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="index.php?content=productenpage&action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="./img/icon-delete.png" alt="Remove Item" /></a></td>
				</tr>
				<?php
...
<div id="product-grid">
	...
	?>
		<div class="product-item" id="imageproduct">
			<form method="post" action="index.php?content=productenpage&action=add&pid=<?php echo $row["id"]; ?>">

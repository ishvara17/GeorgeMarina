  ...
  switch($alert) {
    ...
    case "register-success" :
      echo '<div class="alert alert-success mt-5 w-50 mx-auto text-center" role="alert">
              U bent succesvol geregistreerd. U ontvangt een e-mail van ons met daarin een activatielink. <br>
              <a href="./index.php?content=login">Klik hier om door te gaan.</a>
            </div>';
